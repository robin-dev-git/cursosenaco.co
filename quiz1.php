...
<div class="container">
    ...
    <form action="quiz1.php" method="POST">
        ...
        <div class="form-check">
            ...
            <ol type="a">
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p6" value="a">
                    <label class="form-check-label ms-2" for="p6">
                        <img src="assets\img\quiz\az_3.jpg" class="rounded" height="120px" alt="...">
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p6" value="b">
                    <label class="form-check-label ms-2" for="p6">
                        <img src="assets\img\quiz\az_17.jpg" class="rounded" height="120px" alt="...">
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p6" value="c">
                    <label class="form-check-label ms-2" for="p6">
                        <img src="assets\img\quiz\az_11.jpg" class="rounded" height="120px" alt="...">
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p6" value="d">
                    <label class="form-check-label ms-2" for="p6">
            ...
            <ol type="a">
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p7" value="a">
                    <label class="form-check-label ms-2" for="p7">
                        I
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p7" value="b">
                    <label class="form-check-label ms-2" for="p7">
                        Y
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p7" value="c">
                    <label class="form-check-label ms-2" for="p7">
                        G
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p7" value="d">
                    <label class="form-check-label ms-2" for="p7">
                        H
                    </label>
                </li>
            ...
            <ol type="a">
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p8" value="a">
                    <label class="form-check-label ms-2" for="p8">
                        <img src="assets\img\quiz\az_13.jpg" class="rounded" height="120px" alt="...">
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p8" value="b">
                    <label class="form-check-label ms-2" for="p8">
                        <img src="assets\img\quiz\az_25.jpg" class="rounded" height="120px" alt="...">
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p8" value="c">
                    <label class="form-check-label ms-2" for="p8">
                        <img src="assets\img\quiz\az_3.jpg" class="rounded" height="120px" alt="...">
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p8" value="d">
                    <label class="form-check-label ms-2" for="p8">
            ...
            <ol type="a">
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p9" value="a">
                    <label class="form-check-label ms-2" for="p9">
                        N
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p9" value="b">
                    <label class="form-check-label ms-2" for="p9">
                        M
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p9" value="c">
                    <label class="form-check-label ms-2" for="p9">
                        Ñ
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p9" value="d">
                    <label class="form-check-label ms-2" for="p9">
                        W
                    </label>
                </li>
            ...
            <ol type="a">
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p10" value="a">
                    <label class="form-check-label ms-2" for="p10">
                        W
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p10" value="b">
                    <label class="form-check-label ms-2" for="p10">
                        U
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p10" value="c">
                    <label class="form-check-label ms-2" for="p10">
                        V
                    </label>
                </li>
                <li>
                    <input class="form-check-input ms-2" type="radio" name="p10" value="d">
                    <label class="form-check-label ms-2" for="p10">
                        Y
                    </label>
                </li>
